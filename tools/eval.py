...
if __name__ == '__main__':
    from ppdet.modeling.fusions.fusion import ModalityInteraction
    import ppdet.core.workspace as workspace

    # 强制验证注册
    if 'ModalityInteraction' not in workspace.global_config:
        workspace.register(ModalityInteraction)
        print("⚠️ 手动注册 ModalityInteraction 成功")
    else:
        print("✓ ModalityInteraction 已自动注册")
    main()
